...
export default function PlaylistDetailsPage() {
  ...
  const { playlists, playQueue, downloadSong, removeFromPlaylist, deletePlaylist, renamePlaylist } = useMusic();
  ...
  const hasTracks = playlist ? playlist.tracks.length > 0 : false;
